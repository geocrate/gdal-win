...
use crate::gdal_sys::{OGRErr, OSRAxisMappingStrategy};
...
#[derive(Debug)]
pub struct SpatialRef(crate::gdal_sys::OGRSpatialReferenceH);

impl Drop for SpatialRef {
    fn drop(&mut self) {
        unsafe { crate::gdal_sys::OSRRelease(self.0) };
        self.0 = ptr::null_mut();
    }
}
...
impl Clone for SpatialRef {
    fn clone(&self) -> SpatialRef {
        let n_obj = unsafe { crate::gdal_sys::OSRClone(self.0) };
        SpatialRef(n_obj)
    }
}
...
impl PartialEq for SpatialRef {
    fn eq(&self, other: &SpatialRef) -> bool {
        unsafe { crate::gdal_sys::OSRIsSame(self.0, other.0) == 1 }
    }
}

impl SpatialRef {
    pub fn new() -> Result<SpatialRef> {
        let c_obj = unsafe { crate::gdal_sys::OSRNewSpatialReference(ptr::null()) };
        if c_obj.is_null() {
    ...
    pub unsafe fn from_c_obj(c_obj: crate::gdal_sys::OGRSpatialReferenceH) -> Result<SpatialRef> {
        assert!(!c_obj.is_null(), "Expected a pointer that is not null");
        let mut_c_obj = crate::gdal_sys::OSRClone(c_obj);
    ...
    /// Returns a C pointer to the allocated [`crate::gdal_sys::OGRSpatialReferenceH`] memory.
    pub fn to_c_hsrs(&self) -> crate::gdal_sys::OGRSpatialReferenceH {
        self.0
    }
    ...
    pub fn from_definition(definition: &str) -> Result<SpatialRef> {
        ...
        let rv =
            unsafe { crate::gdal_sys::OSRSetFromUserInput(c_obj, CString::new(definition)?.as_ptr()) };
    ...
    pub fn from_wkt(wkt: &str) -> Result<SpatialRef> {
        ...
        let c_obj = unsafe { crate::gdal_sys::OSRNewSpatialReference(c_str.as_ptr()) };
        if c_obj.is_null() {
            return Err(_last_null_pointer_err("OSRNewSpatialReference"));
        }
        Ok(SpatialRef(c_obj))
    ...
    pub fn from_epsg(epsg_code: u32) -> Result<SpatialRef> {
        ...
        let c_obj = unsafe { crate::gdal_sys::OSRNewSpatialReference(null_ptr) };
        let rv = unsafe { crate::gdal_sys::OSRImportFromEPSG(c_obj, epsg_code as c_int) };
        if rv != OGRErr::OGRERR_NONE {
    ...
    pub fn from_proj4(proj4_string: &str) -> Result<SpatialRef> {
        ...
        let null_ptr = ptr::null_mut();
        let c_obj = unsafe { crate::gdal_sys::OSRNewSpatialReference(null_ptr) };
        let rv = unsafe { crate::gdal_sys::OSRImportFromProj4(c_obj, c_str.as_ptr()) };
        if rv != OGRErr::OGRERR_NONE {
            Err(GdalError::OgrError {
                err: rv,
    ...
    pub fn from_esri(esri_wkt: &str) -> Result<SpatialRef> {
        ...
        let null_ptr = ptr::null_mut();
        let c_obj = unsafe { crate::gdal_sys::OSRNewSpatialReference(null_ptr) };
        let rv = unsafe { crate::gdal_sys::OSRImportFromESRI(c_obj, ptrs.as_mut_ptr()) };
        if rv != OGRErr::OGRERR_NONE {
            Err(GdalError::OgrError {
                err: rv,
    ...
    pub fn to_wkt(&self) -> Result<String> {
        ...
        let rv = unsafe { crate::gdal_sys::OSRExportToWkt(self.0, &mut c_wkt) };
        ...
        unsafe { crate::gdal_sys::VSIFree(c_wkt.cast::<std::ffi::c_void>()) };
        res
    }

    pub fn morph_to_esri(&self) -> Result<()> {
        let rv = unsafe { crate::gdal_sys::OSRMorphToESRI(self.0) };
        if rv != OGRErr::OGRERR_NONE {
            return Err(GdalError::OgrError {
                err: rv,
    ...
    pub fn to_pretty_wkt(&self) -> Result<String> {
        let mut c_wkt = ptr::null_mut();
        let rv = unsafe { crate::gdal_sys::OSRExportToPrettyWkt(self.0, &mut c_wkt, false as c_int) };
        let res = if rv != OGRErr::OGRERR_NONE {
            Err(GdalError::OgrError {
                err: rv,
    ...
    pub fn to_xml(&self) -> Result<String> {
        ...
        let rv = unsafe { crate::gdal_sys::OSRExportToXML(self.0, &mut c_raw_xml, ptr::null()) };
        let res = if rv != OGRErr::OGRERR_NONE {
            Err(GdalError::OgrError {
                err: rv,
        ...
        unsafe { crate::gdal_sys::VSIFree(c_raw_xml.cast::<std::ffi::c_void>()) };
        res
    }

    pub fn to_proj4(&self) -> Result<String> {
        let mut c_proj4str = ptr::null_mut();
        let rv = unsafe { crate::gdal_sys::OSRExportToProj4(self.0, &mut c_proj4str) };
        let res = if rv != OGRErr::OGRERR_NONE {
            Err(GdalError::OgrError {
                err: rv,
        ...
        unsafe { crate::gdal_sys::VSIFree(c_proj4str.cast::<std::ffi::c_void>()) };
        res
    }
    ...
    pub fn to_projjson(&self) -> Result<String> {
        ...
        let rv = unsafe { crate::gdal_sys::OSRExportToPROJJSON(self.0, &mut c_projjsonstr, options) };
        let res = if rv != OGRErr::OGRERR_NONE {
            Err(GdalError::OgrError {
                err: rv,
        ...
        unsafe { crate::gdal_sys::VSIFree(c_projjsonstr.cast::<std::ffi::c_void>()) };
        res
    }

    pub fn auth_name(&self) -> Option<String> {
        let c_ptr = unsafe { crate::gdal_sys::OSRGetAuthorityName(self.0, ptr::null()) };
        _string(c_ptr)
    }
    ...
    pub fn auth_code(&self) -> Result<i32> {
        ...
        let c_ptr = unsafe { crate::gdal_sys::OSRGetAuthorityCode(self.0, ptr::null()) };
        if c_ptr.is_null() {
            return Err(err);
        }
    ...
    pub fn auto_identify_epsg(&mut self) -> Result<()> {
        let rv = unsafe { crate::gdal_sys::OSRAutoIdentifyEPSG(self.0) };
        if rv != OGRErr::OGRERR_NONE {
            Err(GdalError::OgrError {
                err: rv,
    ...
    pub fn name(&self) -> Option<String> {
        let c_ptr = unsafe { crate::gdal_sys::OSRGetName(self.0) };
        _string(c_ptr)
    }

    pub fn angular_units_name(&self) -> Option<String> {
        let mut c_ptr = ptr::null_mut();
        unsafe { crate::gdal_sys::OSRGetAngularUnits(self.0, &mut c_ptr) };
        _string(c_ptr)
    }

    pub fn angular_units(&self) -> f64 {
        unsafe { crate::gdal_sys::OSRGetAngularUnits(self.0, ptr::null_mut()) }
    }

    pub fn linear_units_name(&self) -> Option<String> {
        let mut c_ptr = ptr::null_mut();
        unsafe { crate::gdal_sys::OSRGetLinearUnits(self.0, &mut c_ptr) };
        _string(c_ptr)
    }

    pub fn linear_units(&self) -> f64 {
        unsafe { crate::gdal_sys::OSRGetLinearUnits(self.0, ptr::null_mut()) }
    }

    #[inline]
    pub fn is_geographic(&self) -> bool {
        unsafe { crate::gdal_sys::OSRIsGeographic(self.0) == 1 }
    }

    #[inline]
    pub fn is_derived_geographic(&self) -> bool {
        unsafe { crate::gdal_sys::OSRIsDerivedGeographic(self.0) == 1 }
    }

    #[inline]
    pub fn is_local(&self) -> bool {
        unsafe { crate::gdal_sys::OSRIsLocal(self.0) == 1 }
    }

    #[inline]
    pub fn is_projected(&self) -> bool {
        unsafe { crate::gdal_sys::OSRIsProjected(self.0) == 1 }
    }

    #[inline]
    pub fn is_compound(&self) -> bool {
        unsafe { crate::gdal_sys::OSRIsCompound(self.0) == 1 }
    }

    #[inline]
    pub fn is_geocentric(&self) -> bool {
        unsafe { crate::gdal_sys::OSRIsGeocentric(self.0) == 1 }
    }

    #[inline]
    pub fn is_vertical(&self) -> bool {
        unsafe { crate::gdal_sys::OSRIsVertical(self.0) == 1 }
    }
    ...
    pub fn axis_orientation(
        ...
        let mut orientation = crate::gdal_sys::OGRAxisOrientation::OAO_Other;
        let c_ptr = unsafe {
            crate::gdal_sys::OSRGetAxis(
                self.0,
    ...
    pub fn axes_count(&self) -> i32 {
        unsafe { crate::gdal_sys::OSRGetAxesCount(self.0) }
    }
    ...
    pub fn set_axis_mapping_strategy(&mut self, strategy: AxisMappingStrategy) {
        unsafe {
            crate::gdal_sys::OSRSetAxisMappingStrategy(self.0, strategy.gdal_ordinal());
        }
    }
    ...
    pub fn axis_mapping_strategy(&self) -> AxisMappingStrategy {
        let id = unsafe { crate::gdal_sys::OSRGetAxisMappingStrategy(self.0) };
    ...
    pub fn area_of_use(&self) -> Option<AreaOfUse> {
        ...
        let (mut w_long, mut s_lat, mut e_long, mut n_lat): (f64, f64, f64, f64) =
            (0.0, 0.0, 0.0, 0.0);
        let ret_val = unsafe {
            crate::gdal_sys::OSRGetAreaOfUse(
                self.0,
                &mut w_long,
                &mut s_lat,
                &mut e_long,
    ...
    pub fn semi_major(&self) -> Result<f64> {
        ...
        let a = unsafe { crate::gdal_sys::OSRGetSemiMajor(self.0, &mut err_code as *mut u32) };
    ...
    pub fn semi_minor(&self) -> Result<f64> {
        let mut err_code = OGRErr::OGRERR_NONE;
        let b = unsafe { crate::gdal_sys::OSRGetSemiMinor(self.0, &mut err_code as *mut u32) };
        if err_code != OGRErr::OGRERR_NONE {
            return Err(GdalError::OgrError {
                err: err_code,
    ...
    pub fn set_proj_param(&mut self, name: &str, value: f64) -> Result<()> {
        ...
        let rv = unsafe { crate::gdal_sys::OSRSetProjParm(self.0, c_name.as_ptr(), value) };
        if rv != OGRErr::OGRERR_NONE {
            return Err(GdalError::OgrError {
                err: rv,
    ...
    pub fn get_proj_param(&self, name: &str) -> Result<Option<f64>> {
        ...
        let mut err_code = OGRErr::OGRERR_NONE;
        let p = unsafe {
            crate::gdal_sys::OSRGetProjParm(self.0, c_name.as_ptr(), 0.0, &mut err_code as *mut u32)
        };
        if err_code != OGRErr::OGRERR_NONE {
            match err_code {
    ...
    pub fn set_attr_value(&mut self, node_path: &str, new_value: Option<&str>) -> Result<()> {
        ...
        let value_ptr = c_new_value
            ...
            .map(|s| s.as_ptr())
            .unwrap_or(ptr::null());
        let rv = unsafe { crate::gdal_sys::OSRSetAttrValue(self.0, c_node_path.as_ptr(), value_ptr) };
        if rv != OGRErr::OGRERR_NONE {
            return Err(GdalError::OgrError {
                err: rv,
    ...
    pub fn get_attr_value(&self, node_path: &str, child: usize) -> Result<Option<String>> {
        ...
        let c_node_path = CString::new(node_path)?;
        let c_ptr = unsafe { crate::gdal_sys::OSRGetAttrValue(self.0, c_node_path.as_ptr(), child) };
        Ok(_string(c_ptr))
    }
    ...
    pub fn geog_cs(&self) -> Result<SpatialRef> {
        let raw_ret = unsafe { crate::gdal_sys::OSRCloneGeogCS(self.0) };
        if raw_ret.is_null() {
...
pub enum AxisMappingStrategy {
    ...
    /// The data axes are custom-defined via [`crate::gdal_sys::OSRSetDataAxisToSRSAxisMapping`].
...
mod tests {
    ...
    fn crs_axis() {
        ...
        assert_eq!(orientation, crate::gdal_sys::OGRAxisOrientation::OAO_North);
