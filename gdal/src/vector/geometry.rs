...
use crate::gdal_sys::{OGRErr, OGRGeometryH, OGRwkbGeometryType};
...
impl Geometry {
    ...
    pub fn empty(wkb_type: OGRwkbGeometryType::Type) -> Result<Geometry> {
        let c_geom = unsafe { crate::gdal_sys::OGR_G_CreateGeometry(wkb_type) };
        if c_geom.is_null() {
    ...
    pub fn is_empty(&self) -> bool {
        unsafe { crate::gdal_sys::OGR_G_IsEmpty(self.c_geometry()) == 1 }
    }
    ...
    pub fn set_point_zm(&mut self, i: usize, point: (f64, f64, f64, f64)) {
        let (x, y, z, m) = point;
        unsafe {
            crate::gdal_sys::OGR_G_SetPointZM(
                self.c_geometry(),
                i as c_int,
                x as c_double,
                y as c_double,
    ...
    pub fn set_point_m(&mut self, i: usize, point: (f64, f64, f64)) {
        let (x, y, m) = point;
        unsafe {
            crate::gdal_sys::OGR_G_SetPointM(
                self.c_geometry(),
                i as c_int,
                x as c_double,
                y as c_double,
    ...
    pub fn set_point_2d(&mut self, i: usize, p: (f64, f64)) {
        let (x, y) = p;
        unsafe {
            crate::gdal_sys::OGR_G_SetPoint_2D(self.c_geometry(), i as c_int, x as c_double, y as c_double)
        };
    }
    ...
    pub fn add_point_2d(&mut self, p: (f64, f64)) {
        let (x, y) = p;
        unsafe { crate::gdal_sys::OGR_G_AddPoint_2D(self.c_geometry(), x as c_double, y as c_double) };
    }

    pub fn add_point_zm(&mut self, p: (f64, f64, f64, f64)) {
        let (x, y, z, m) = p;
        unsafe {
            crate::gdal_sys::OGR_G_AddPointZM(
                self.c_geometry(),
                x as c_double,
                y as c_double,
                z as c_double,
    ...
    pub fn add_point_m(&mut self, p: (f64, f64, f64)) {
        let (x, y, m) = p;
        unsafe {
            crate::gdal_sys::OGR_G_AddPointM(
                self.c_geometry(),
                x as c_double,
                y as c_double,
                m as c_double,
    ...
    pub fn get_point(&self, index: i32) -> (f64, f64, f64) {
        ...
        unsafe { crate::gdal_sys::OGR_G_GetPoint(self.c_geometry(), index, &mut x, &mut y, &mut z) };
        (x, y, z)
    }
    ...
    pub fn get_point_zm(&self, index: i32) -> (f64, f64, f64, f64) {
        ...
        unsafe {
            crate::gdal_sys::OGR_G_GetPointZM(self.c_geometry(), index, &mut x, &mut y, &mut z, &mut m)
        };
        (x, y, z, m)
    }
    ...
    pub fn get_points(&self, out_points: &mut Vec<(f64, f64, f64)>) -> usize {
        ...
        let length = unsafe { crate::gdal_sys::OGR_G_GetPointCount(self.c_geometry()) };
    ...
    pub fn geometry_type(&self) -> OGRwkbGeometryType::Type {
        unsafe { crate::gdal_sys::OGR_G_GetGeometryType(self.c_geometry()) }
    }
    ...
    pub fn geometry_name(&self) -> String {
        ...
        let c_str = unsafe { crate::gdal_sys::OGR_G_GetGeometryName(self.c_geometry()) };
    ...
    pub fn geometry_count(&self) -> usize {
        let cnt = unsafe { crate::gdal_sys::OGR_G_GetGeometryCount(self.c_geometry()) };
        cnt as usize
    }
    ...
    pub fn point_count(&self) -> usize {
        let cnt = unsafe { crate::gdal_sys::OGR_G_GetPointCount(self.c_geometry()) };
        cnt as usize
    }
    ...
    pub unsafe fn get_unowned_geometry(&self, n: usize) -> Geometry {
        ...
        // object for long.
        let c_geom = crate::gdal_sys::OGR_G_GetGeometryRef(self.c_geometry(), n as c_int);
    ...
    pub fn add_geometry(&mut self, mut sub: Geometry) -> Result<()> {
        ...
        sub.owned = false;
        let rv =
            unsafe { crate::gdal_sys::OGR_G_AddGeometryDirectly(self.c_geometry(), sub.c_geometry()) };
    ...
    pub fn length(&self) -> f64 {
        unsafe { crate::gdal_sys::OGR_G_Length(self.c_geometry()) }
    }
    ...
    pub fn area(&self) -> f64 {
        unsafe { crate::gdal_sys::OGR_G_Area(self.c_geometry()) }
    }
    ...
    pub fn envelope(&self) -> Envelope {
        ...
        unsafe {
            crate::gdal_sys::OGR_G_GetEnvelope(self.c_geometry(), envelope.as_mut_ptr());
    ...
    pub fn envelope_3d(&self) -> Envelope3D {
        let mut envelope = MaybeUninit::uninit();
        unsafe {
            crate::gdal_sys::OGR_G_GetEnvelope3D(self.c_geometry(), envelope.as_mut_ptr());
            envelope.assume_init()
        }
    }
    ...
    pub fn flatten_to_2d(&mut self) {
        unsafe { crate::gdal_sys::OGR_G_FlattenTo2D(self.c_geometry()) };
    }
    ...
    pub fn spatial_ref(&self) -> Option<SpatialRef> {
        let c_spatial_ref = unsafe { crate::gdal_sys::OGR_G_GetSpatialReference(self.c_geometry()) };
    ...
    pub fn set_spatial_ref(&mut self, spatial_ref: SpatialRef) {
        unsafe {
            crate::gdal_sys::OGR_G_AssignSpatialReference(self.c_geometry(), spatial_ref.to_c_hsrs())
        };
    }
    ...
    pub fn is_valid(&self) -> bool {
        let p = unsafe { crate::gdal_sys::OGR_G_IsValid(self.c_geometry()) };
        p != 0
    }
}
...
impl Drop for Geometry {
    fn drop(&mut self) {
        if self.owned {
            ...
            unsafe { crate::gdal_sys::OGR_G_DestroyGeometry(c_geometry.unwrap()) };
        }
    }
}
...
impl Clone for Geometry {
    fn clone(&self) -> Geometry {
        // assert!(self.has_gdal_ptr());
        let c_geometry = self.c_geometry_ref.borrow();
        let new_c_geom = unsafe { crate::gdal_sys::OGR_G_Clone(c_geometry.unwrap()) };
...
impl PartialEq for Geometry {
    fn eq(&self, other: &Self) -> bool {
        unsafe { crate::gdal_sys::OGR_G_Equals(self.c_geometry(), other.c_geometry()) != 0 }
    }
}
...
pub fn geometry_type_to_name(ty: OGRwkbGeometryType::Type) -> String {
    let rv = unsafe { crate::gdal_sys::OGRGeometryTypeToName(ty) };
...
pub fn geometry_type_set_m(ty: OGRwkbGeometryType::Type) -> OGRwkbGeometryType::Type {
    unsafe { crate::gdal_sys::OGR_GT_SetM(ty) }
}
